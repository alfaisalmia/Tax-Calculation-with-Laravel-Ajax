    ...
    <div class="col-md-10 col-lg-10">
            ...
            <div class="row"style="background-color: white">
                <div class="col-md-12 ulockd-mrgn1210">
                    ...
                    <h5>Click on "Add New Record" to input your self education expenses. You can report expenses related to tuition and materials for self education that directly impact your occupational skills, lead to increased income, or are otherwise directly related to your employment.
</h5>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <a href="{{URL('/deduction/selfEducation/form')}}" class="btn btn-warning block btn-sm"><i class="fa fa-plus">  </i> &nbsp; Add New Record</a><br/>
                    </div>
                </div> <br/>
              <br/><br/><br/>
                <div class="col-sm-12">
