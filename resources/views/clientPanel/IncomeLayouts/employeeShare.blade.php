    ...
    <div class="col-md-10 col-lg-10">
            ...
            <div class="row"style="background-color: white">
                <div class="col-md-12 ulockd-mrgn1210">
                    ...
                    <h5>Click on "Add New Record" to report discounts on employee share schemes</h5>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <a href="{{URL('/income/employeeShare/schemes')}}" class="btn btn-warning block btn-sm"><i class="fa fa-plus">  </i> &nbsp; Add New Record</a><br/>
                    </div>
                </div> <br/>
<br/><br/><br/><br/>
